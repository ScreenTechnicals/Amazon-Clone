...
import { MdShoppingCart, MdMenu, MdHelpCenter } from "react-icons/md";
          ...
          <Link href={"/cart"}>
            ...
            <button className="relative group">
              ...
              <div className="absolute top-10 -left-[220px] border shadow-md rounded-md p-5 w-[250px] bg-white hidden xl:group-focus:hidden group-focus:block space-y-4">
                ...
                <div className="w-full bg-[#000] flex space-x-2 items-center justify-center uppercase tracking-widest text-white transition-colors px-3 py-2 rounded-xl">
