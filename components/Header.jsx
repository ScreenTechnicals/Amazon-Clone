      ...
      <div className=" flex items-center justify-between md:space-x-5 space-x-3">
        ...
        <div className="w-full md:block hidden">
          <form onSubmit={searchSubmit} className="w-full flex items-center">
            <input
              type="text"
              className="w-full px-3 py-[10.5px] border border-gray-200 bg-transparent rounded-l-md focus:border-[#ff9900] outline-none"
              ...
              value={search}
            />
            <button className="text-2xl bg-[#ff9900] p-[9px] rounded-r-md">
              <AiOutlineSearch />
            </button>
          </form>
        </div>
        <div className="flex items-center space-x-7">
          ...
          <button className="relative group">
            ...
            <div className="absolute top-10 -left-[220px] border shadow-md rounded-md p-5 w-[250px] bg-white hidden xl:group-focus:hidden group-focus:block space-y-4">
              ...
              {user ? (
                <div
                  className="w-full bg-[#000] flex space-x-2 items-center justify-center uppercase tracking-widest text-white transition-colors px-3 py-2 rounded-xl"
                  onClick={logout}
                >
                  <span className="text-2xl">
                    <FiLogOut />
